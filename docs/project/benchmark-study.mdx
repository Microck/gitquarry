...
![Benchmark latency profile](/images/benchmark-study/latency-profile.svg)
...
![Scenario churn versus the native baseline](/images/benchmark-study/baseline-churn.svg)
...
![Most persistent repositories across the study](/images/benchmark-study/persistence-leaders.svg)
