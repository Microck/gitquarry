...
![Benchmark latency profile](/images/benchmark-study/latency-profile.png?v=20260423-altair)

![Depth overhead versus the native path](/images/benchmark-study/depth-overhead.png?v=20260423-altair)

![README enrichment tax](/images/benchmark-study/readme-tax.png?v=20260423-altair)
...
![Balanced-mode tradeoff map](/images/benchmark-study/balanced-tradeoff.png?v=20260423-altair)

![Balanced frontier map](/images/benchmark-study/balanced-pareto.png?v=20260423-altair)

![Baseline core retention](/images/benchmark-study/core-retention.png?v=20260423-altair)

![Balanced-mode surface attribution mix](/images/benchmark-study/surface-mix.png?v=20260423-altair)

These charts are rendered directly from the benchmark CSV artifacts for the docs site. The exact audit trail for values and scenario comparisons still lives in `report.md`, `paired-effects.csv`, and `scenario-analysis.csv`.
...
![Scenario churn versus the native baseline](/images/benchmark-study/baseline-churn.png?v=20260423-altair)

![Most persistent repositories across the study](/images/benchmark-study/persistence-leaders.png?v=20260423-altair)
